...
const highlight = {
  heading: "HIGHLIGHTS",
  title: "MIPOSSIBLE WITH LIMITLESS CHOICES",
  text: "Our Purpose is to move the world forward. We take action by building community, protecting our planet and increasing access to sustainibility.",
  btn: "Explore More",
  url: "#",
  img: hightlightimg,
};
...
const sneaker = {
  heading: "FEATURED",
  title: "THIS IS FOR FEATURED PRODUCTS",
  text: "Artificial intelligence plays a significant role in the clothing business, offering numerous benefits and opportunities for growth.",
  btn: "Explore More",
  url: "#",
  img: sneakershoe,
};

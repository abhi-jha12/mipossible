  ...
  return (
    <>
      <header
        className={
          !navState
            ? "absolute top-0 left-0 right-0 h-[9vh] flex items-center justify-center  opacity-100 z-50 bg-[#38ACEC]"
              ...
              >
                {user && user.photoURL ? (
                  ...
                  <img
                    src={user.photoURL}
                    alt="Profile"
                    className={`icon-style rounded-full ${
                      navState && "ring-2 ring-white"
                    }`}
                  />
                ) : (
